...
@section('content')
  	...
  	{!! Form::open(['action' => ['MemberController@update', $member->id ], 'method' => 'POST','files' => true,'class'=> 'm-form m-form--fit m-form--label-align-right']) !!}
						  ...
						  {{ Form::text('fname',$member->fname,['class'=>'form-control m-input','placeholder'=>" Please enter your first name", 'required' => '']) }}
                          ...
                          {{ Form::label('lname', '* Last Name:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('lname',$member->sname,['class'=>'form-control m-input','placeholder'=>" Please enter your Last name", 'required' => '']) }}
						  ...
						  {{ Form::text('pnumber',$member->phone_number,['class'=>'form-control m-input','placeholder'=>" Please enter your  Phone", 'required' => '']) }}
                                                               </div>
                                                            </div>
                                                        </div>
                          ...
                          {{ Form::label('dob', '* DOB:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('dob',$member->dob,['class'=>'form-control m-input', 'required' => '']) }}
                                                            </div>
                                                    </div>
                          ...
                          {{ Form::label('point', '* Points:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('point',$member->points,['class'=>'form-control m-input','placeholder'=>" Please enter your   points", 'required' => '']) }}
                                                            </div>
                                                    </div>
                          ...
                          {{ Form::label('level', '* Level:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('level',$member->level,['class'=>'form-control m-input','placeholder'=>"Level", 'required' => '']) }}
                                                            </div>
                                                    </div>
                          ...
                          {{ Form::label('details', '* Details:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::textarea('details',$member->details,['class'=>'form-control m-input','placeholder'=>"Detail", ]) }}
                                                            </div>
                                                    </div>
						  ...
						  {{ Form::text('email',$member->email,['class'=>'form-control m-input','placeholder'=>"Your Email", 'required' => '']) }}
