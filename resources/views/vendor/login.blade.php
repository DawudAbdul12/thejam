		...
		<div class="m-login__container">
			...
			<div class="m-login__signin">
				<div class="m-login__head">
					<h3 class="m-login__title">Sign In Vendor</h3>
				</div>
				      
                        <form method="POST" class="m-login__form m-form" action='/login/vendor' aria-label="{{ __('Login') }}">
                       
                            @csrf
						<!-- <form method="POST" class="m-login__form m-form" action="{{ route('/login/admin') }}"> -->
					...
					<div class="row m-login__form-sub">
						...
						<div class="col m--align-right m-login__form-right">
								...
								<a class="m_login_forget_password" href="{{ route('password.request') }}">
