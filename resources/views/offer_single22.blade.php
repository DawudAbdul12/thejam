    ...
    <div class="container-fluid webmag">
      <div class="row">
        ...
        <div class="col-12 col-md-7">
          ...
          <div class="row px-3">
            <div class="col-10">
              <h5 class="mb-0 wc">Join guest list offer type</h5>
      ...
      <div class="row mb-5">
       <div class="col-12 text-center px-0 pl-md-4 my-5">
        <button type="button" class="btn btn-jam btn-lg btn-block">Join Guest List</button>
      </div>
    </div>
      </div>
      <!-- left side content -->
    ...
    <div class="row"> 
      ...
      <div class="col-12">
         <div class="owl-carousel owl-hit owl-theme">
          ...
          <img src="img/port7.jpg" alt="" class="vasimg">
          <div class="overlay-light-black"></div>
          <div class="text-contain">
            <div class="row ">
              <div class="col-10">
             ...
             <div class="col-2"> <a href="#"><i class="fa fa-heart-o fa-2x wc" aria-hidden="true"></i></a></div>
           </div>
         </div>
       </div>
