                            ...
                            <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                                <div class="m-portlet__head">
                                    ...
                                    <div class="m-portlet__head-wrapper">
                                        ...
                                        {{-- FORM START --}}
  {!! Form::open(['action' => 'ListingsController@store', 'method' => 'POST','files' => true,'class'=> 'm-form m-form--fit m-form--label-align-right'] ) !!}
                                        {{-- FORM START --}}
                                            <div class="btn-group">
                          ...
                          {{ Form::label('name', '*Product Name:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('name',"",['class'=>'form-control m-input','placeholder'=>" Please enter product name", 'required' => '']) }}
                          ...
                          {{ Form::label('location', '* Location:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('location',"",['class'=>'form-control m-input','placeholder'=>" Please enter Location", 'required' => '']) }}
                                                         </div>
                                                </div>

                                     	<div class="form-group m-form__group row">
				         {{ Form::label('type', 'Select Type', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                 <div class="col-xl-9 col-lg-9">
						 {{ Form::select('type', ['1' => '1', '2' => '1'], '1', ['class'=>'form-control m-input','placeholder' => 'Select a vendor...']) }}
                          ...
                          {{ Form::label('price', '* Enter Price:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('price',"",['class'=>'form-control m-input','placeholder'=>" Please enter Price", 'required' => '']) }}
                                                         </div>
                                                </div>
                          ...
                          {{ Form::label('start_time', '* Start Time:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('start_time',"",['class'=>'form-control m-input','placeholder'=>" Start Time", 'required' => '']) }}
                                                            </div>
                                                    </div>
                          ...
                          {{ Form::label('end_time', '* End Time:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('end_time',"",['class'=>'form-control m-input','placeholder'=>"End Time", 'required' => '']) }}
                                                            </div>
                                                    </div>
