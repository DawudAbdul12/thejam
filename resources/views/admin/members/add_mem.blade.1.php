...
@section('content')
  ...
  {!! Form::open(['action' => 'MemberController@store', 'method' => 'POST','files' => true,'class'=> 'm-form m-form--fit m-form--label-align-right'] ) !!}
                          ...
                          {{ Form::label('point', '* Points:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('point',"",['class'=>'form-control m-input','placeholder'=>" Please enter your   points", 'required' => '']) }}
                                                            </div>
                                                    </div>
                          ...
                          {{ Form::label('level', '* Level:', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                            <div class="col-xl-9 col-lg-9">
						  {{ Form::text('level',"",['class'=>'form-control m-input','placeholder'=>"Level", 'required' => '']) }}
                                                            </div>
                                                    </div>
