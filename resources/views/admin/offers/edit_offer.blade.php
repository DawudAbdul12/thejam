...
@section('content')
  ...
  {!! Form::open(['action' =>  ['OffersController@update', $offer->id ], 'method' => 'POST','files' => true,'class'=> 'm-form m-form--fit m-form--label-align-right'] ) !!}
						  ...
						  {{ Form::text('slug',$offer->slug,['class'=>'form-control m-input','placeholder'=>" Please enter slug", 'required' => '']) }}
                                     	...
                                     	<div class="form-group m-form__group row">
				         {{ Form::label('vendor', 'Select Vendor', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                 <div class="col-xl-9 col-lg-9">

                                                <select class="form-control" id="vendor" name="vendor" onchange="loadLocation()">
                                                         <option >Select a vendor...</option>
                                                      @php
                                                                foreach ($vendors as $key => $vendor) {
                                                       if($vendor['id'] == $offer->vendor_id){
                                                        echo  '<option value="'.$vendor['id'].'" selected>'.$vendor['fname']."  ".$vendor['lname'].'</option>';
                                                       }else{
                                                        echo  '<option value="'.$vendor['id'].' ">'.$vendor['fname']."  ".$vendor['lname'].'</option>';
                                                       }
                                                                        }
                                                          @endphp
                                                 </select>
                                    <input class="form-control" type="hidden" value="{{$vendor['id']}}" id="current_location">
