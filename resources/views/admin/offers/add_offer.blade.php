...
@section('content')
  ...
  {!! Form::open(['action' => 'OffersController@store', 'method' => 'POST','files' => true,'class'=> 'm-form m-form--fit m-form--label-align-right'] ) !!}
                     ...
                     {{ Form::hidden('slug',"",['class'=>'form-control m-input','placeholder'=>" Please enter slug"]) }}
				         ...
				         {{ Form::label('vendor', 'Select Vendor', ['class' => 'col-xl-3 col-lg-3 col-form-label']) }}
                                                 <div class="col-xl-9 col-lg-9">
                                                      ...
                                                      <select class="form-control m-input" id="vendor" name="vendor" onchange="loadLocation()">
