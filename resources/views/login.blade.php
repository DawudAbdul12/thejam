...
<section>
  <div class="container">
      ...
      <div class="col-12 col-md-7 mx-auto text-center loglog ">
        ...
        <div class="col-12  col-md-7 mx-auto loglog">
         ...
         <div class="form-group col-12">
            <input id="email" type="email" class="form-control form-control-log{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}"  placeholder="Email" required autofocus>
                                ...
                                @endif
          {{-- <input type="text" class=" form-control form-control-log" id="" placeholder="Email"> --}}
        </div>
        ...
        <div class="form-group col-12 ">
            ...
            @endif
          {{-- <input type="password" class=" form-control form-control-log" id="" placeholder="Password"> --}}
        </div>
    ...
    <div class="col-12 col-md-7 mx-auto">
        <p class="text-right"><a href=""><small> Forget Password ?</small></a> </p>
    </div>



    <div class="col-12 col-md-7 mx-auto my-5 d-none d-lg-block">
        <button type="submit" class="btn btn-jam btn-lg btn-block"><img src="{{asset('img/login.svg')}}"  width="30"> Login</button>
      </div>
  </div>
</form>
</section>
  ...
  <div class="cx-mimi-footlog  d-md-block d-lg-none">
    <div class="container">
      ...
      <div class="col-12 text-center">
        <a href="profile.php">
          <h4><img src="img/login.svg"  width="30"> Login</h4>
        </a>
      </div>
    </div>
  </div>
